...
class AFC_3MS(afcBoxTurtle):
    MAX_NUM_MOVES = 40
    def __init__(self, config):
        super().__init__(config)
        self.type = config.get('type', '3MS')
    ...
    def handle_connect(self):
        ...
        self.logo = '<span class=success--text>3MS Ready\n</span>'
        self.logo_error = '<span class=error--text>3MS Not Ready</span>\n'
    ...
    def move_to_hub(self, lane: AFCLane, dist: float,
        ...
        :param assist_active: 3MS does not have spoolers, setting this parameter does nothing.
